          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-8">
            ...
            <FadeIn delay={0.2}>
              ...
              <form className="space-y-5">
                ...
                <Button formAction={signup} variant="lingua-blue" className="w-full h-12 text-base">
                  Créer mon compte
                </Button>
              </form>
            </FadeIn>
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              Déjà un compte ?{" "}
              <Link href="/auth/login" className="font-medium text-lingua-blue hover:underline">
                Se connecter
              </Link>
            </p>
          </div>
