            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              {[
                ...
                <FadeIn key={stat.label} delay={0.1 * idx}>
                  <div className="text-4xl md:text-5xl font-bold text-lingua-blue mb-2">{stat.value}</div>
              ...
              {[
                ...
                <FadeIn key={value.title} delay={0.1 * idx}>
                  <div className="text-center p-8 rounded-2xl border border-gray-100 hover:border-gray-200 hover:shadow-lg transition-all duration-300 h-full">
                    <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-lingua-blue/5 mb-6 group-hover:bg-lingua-blue/10 transition-colors">
                      <value.icon className="w-7 h-7 text-lingua-blue" />
                    </div>
